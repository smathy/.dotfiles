...
opt.mousefocus = true
opt.laststatus = 3
opt.titlestring = '%(  %{substitute(expand("%:~"), "/work/juno", "juno", "")}%)'
...
vim.lsp.config('ruby_lsp', {
  init_options = {
    indexing = { excluded_patterns = { "PERF-*/**/*" } },
  },
})

vim.lsp.config('lexical', {
  cmd          = { vim.env.HOME .. '/bin/lexical/bin/start_lexical.sh' },
...
vim.lsp.enable({ 'lexical', 'ruby_lsp' })
